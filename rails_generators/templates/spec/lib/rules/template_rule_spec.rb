...
describe <%=rule_class%>Rule do
  ...
  describe "the expected class options" do    
    it "should be in the 'TODO : Group Name' group" do
      <%=rule_class%>Rule.options[:group].should == "TODO : Group Name"
    end
    
    it "should have the diplay name of 'TODO: Display Name'" do
      <%=rule_class%>Rule.options[:display_name].should == "TODO: Display Name"
    end
