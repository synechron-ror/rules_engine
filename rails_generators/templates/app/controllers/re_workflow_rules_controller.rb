class ReWorkflowRulesController < ApplicationController    
  ...
  before_filter do |controller|
    controller.re_load_model :re_workflow, {:param_id => :re_workflow_id, :redirect_path => :re_workflows_path}    
  end
  
  before_filter :only => [:edit, :update, :destroy, :move_up, :move_down] do |controller|
    controller.re_load_model :re_rule, {:param_id => :id, :parents => [:re_workflow], :redirect_path => :change_re_workflow_path}
  end    
