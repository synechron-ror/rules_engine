...
describe "re_breadcrumbs" do 
  ...
  it "should show the links seperated by a <span>" do
    helper.re_breadcrumbs("<div id=one>one</div>", "<div id=two>two</div>", "<div id=last>last</div>").should have_selector("div.re-breadcrumbs") do |breadcrumbs|
...
describe "re_breadcrumbs_right" do 
  ...
  it "should show the links seperated by a <span>" do
    helper.re_breadcrumbs_right("<div id=one>one</div>", "<div id=two>two</div>", "<div id=last>last</div>", "<div id=right>right</div>").should have_selector("div.re-breadcrumbs") do |breadcrumbs|
      breadcrumbs.should have_selector("div#one", :content => "one") 
