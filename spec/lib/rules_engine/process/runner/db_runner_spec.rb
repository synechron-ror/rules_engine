  ...
  describe "history" do
    describe "no plan code set" do
      ...
      it "should use pagination" do
        RulesEngine::Process::ReProcessRun.history('mock_code', {:page => 1, :per_page => 2}).should == [@re_process_run_2, @re_process_run_3]
      end

      it "should use set pagination" do
        RulesEngine::Process::ReProcessRun.history('mock_code', {:page => 3, :per_page => 1}).should == [@re_process_run_4]
      end
    end
  end
end
