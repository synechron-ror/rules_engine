...
describe "re_alert", :type => :helper do 
  ...
  describe "setting an error message" do
    it "should display the message" do
      call_re_alert("error", "", "").should have_tag('div#re_alert > div.error > strong', :text => "Error :")
      call_re_alert("error", "", "").should have_tag('div#re_alert > div.error > span', :text => "error")
    end
  ...
  describe "setting a success message" do
    it "should display the message" do
      call_re_alert("", "success", "").should have_tag('div#re_alert > div.success > strong', :text => "Success :")
      call_re_alert("", "success", "").should have_tag('div#re_alert > div.success > span', :text => "success")
    end
  ...
  describe "setting a notice message" do
    it "should display the message" do
      call_re_alert("", "", "notice").should have_tag('div#re_alert > div.notice > strong', :text => "Warning :")
      call_re_alert("", "", "notice").should have_tag('div#re_alert > div.notice > span', :text => "notice")
    end
  ...
  describe "setting nothing" do
    it "should have an empty re_alert block" do
      call_re_alert("", "", "").should have_tag('div#re_alert', :text => "")
    end
  end
